...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "abdbqxmdc6neutaj"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//开关7(可下发可上报)
//备注:
#define DPID_SWITCH_7 101
//开关8(可下发可上报)
//备注:
#define DPID_SWITCH_8 102
//开关9(可下发可上报)
//备注:
#define DPID_SWITCH_9 103
//开关10(可下发可上报)
//备注:
#define DPID_SWITCH_10 104
//开关11(可下发可上报)
//备注:
#define DPID_SWITCH_11 105
//开关12(可下发可上报)
//备注:
#define DPID_SWITCH_12 106
//开关13(可下发可上报)
//备注:
#define DPID_SWITCH_13 107
//开关14(可下发可上报)
//备注:
#define DPID_SWITCH_14 108
//开关15(可下发可上报)
//备注:
#define DPID_SWITCH_15 109
//开关16(可下发可上报)
//备注:
#define DPID_SWITCH_16 110

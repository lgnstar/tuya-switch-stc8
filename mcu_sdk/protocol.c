...
void all_data_update(void)
{
    ...
    mcu_dp_bool_update(DPID_SWITCH_1,0); //BOOL型数据上报;
    ...
    mcu_dp_bool_update(DPID_SWITCH_5,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_6,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_ALL,0); //BOOL型数据上报;
    mcu_dp_enum_update(DPID_RELAY_STATUS,0); //枚举型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_7,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_8,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_9,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_10,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_11,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_12,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_13,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_14,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_15,0); //BOOL型数据上报;
    mcu_dp_bool_update(DPID_SWITCH_16,0); //BOOL型数据上报;
}
...
/*****************************************************************************
函数名称 : dp_download_switch_all_handle
功能描述 : 针对DPID_SWITCH_ALL的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_9_handle
功能描述 : 针对DPID_SWITCH_9的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_10_handle
功能描述 : 针对DPID_SWITCH_10的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_11_handle
功能描述 : 针对DPID_SWITCH_11的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_12_handle
功能描述 : 针对DPID_SWITCH_12的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_13_handle
功能描述 : 针对DPID_SWITCH_13的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_14_handle
功能描述 : 针对DPID_SWITCH_14的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_15_handle
功能描述 : 针对DPID_SWITCH_15的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_switch_16_handle
功能描述 : 针对DPID_SWITCH_16的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
